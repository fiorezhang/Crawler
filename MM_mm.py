...
def getImg(url):
    try: 
        ...
        pattern = re.compile('(?i)<img.*?src="(.*?.jpg)"',re.S)
                                    ...
                                    for img in imgs:
                                        ...
                                        if original:
                                            ...
                                            if 'thumb' in img_name and 'x' in img_name:
                                                img = img_root+'/'+img_name[6:-12]+'.jpg'
                                            #print(img)                                        
                                        name_jpg = str(i)+'.jpg'
...
if __name__ == "__main__":
    args = get_args()
    URLROOT = 'https://ygugu4.com/bbs/board.php?bo_table=pic6&wr_id='
    ...
    CLEAN = args.clean
    if ORIGINAL:
        PATH = 'F:/2017/TMP/Download_MM_B'
    else:
        PATH = 'F:/2017/TMP/Download_MM'
